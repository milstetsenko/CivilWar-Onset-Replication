...
bart_estimate$param#outputting the parameters to the estimates - how the outcome 
#grows with treatment growing


#plotting the line of parameters
sample_index <- sample(1:1000, 100)
plot(dta_range$gdpgrowth[sample_index], dta_range$warstds[sample_index], xlab = "",
     ylab = "",
     main = "bart estimate")
